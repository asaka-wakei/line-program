...
function isTimeFormat(str) {
  return /^(9:00|9:30|10:00|10:30|11:00|13:15|13:45|14:15|14:45|15:15|15:45|16:15)$/.test(str);
}
...
function createTimeFlexMessage(date) {
  const times = ['9:00', '9:30', '10:00', '10:30', '11:00', '13:15', '13:45', '14:15', '14:45', '15:15', '15:45', '16:15'];
...
async function handleEvent(event) {
  ...
  if (isTimeFormat(text)) {
    ...
    if (selectedDate) {
      ...
      return client.replyMessage(event.replyToken, {
        type: 'text',
        text: `「${selectedDate} の ${text}」にて承知しました。担当者からご連絡させていただいてから予約確定となります。ご了承ください。※返信は営業時間内になります。
      });
    } else {
      return client.replyMessage(event.replyToken, {
        type: 'text',
